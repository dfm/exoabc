...
public:
    ...
    virtual double get_pdet (double period, double mes) const {
        if (mes >= 7.1) return 1.0;
        return 0.0;
    };
...
public:
    ...
    double get_completeness (double q1, double q2, double period, double rp,
        ...
        pdet = completeness_model_->get_pdet(period, mes);
